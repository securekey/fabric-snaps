...
func TestTransactionSnapInvoke(t *testing.T) {
	...
	snapTxReq := protos.SnapTransactionRequest{ChannelID: "testChannel", ChaincodeID: "ccid", TransientMap: transientMap, EndorserArgs: endorserArgs, AdditionalCCIDs: additionalCCIDs}
