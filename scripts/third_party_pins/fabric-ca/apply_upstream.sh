...
declare -a CLIENT_UTILS_IMPORT_SUBSTS=(
    ...
    's/\"github.com\/hyperledger\/fabric-ca/\"github.com\/securekey\/fabric-snaps\/internal\/github.com\/hyperledger\/fabric-ca/g'
    ...
    '/clog.\"github.com\/cloudflare\/cfssl\/log/!s/\"github.com\/cloudflare\/cfssl\/log/log\"github.com\/securekey\/fabric-snaps\/internal\/github.com\/hyperledger\/fabric-ca\/sdkpatch\/logbridge/g'
