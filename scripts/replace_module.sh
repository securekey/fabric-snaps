...
sed 's/\gerrit.securekey.com\/fabric-next.*/$GOPATH\/src\/github.com\/hyperledger\/fabric/g' -i $GOPATH/src/github.com/hyperledger/fabric/plugins/go.mod
...
sed 's/\gerrit.securekey.com\/fabric-next.*/$GOPATH\/src\/github.com\/hyperledger\/fabric/g' -i $GOPATH/src/github.com/hyperledger/fabric/plugins/util/rolesmgr/go.mod
...
sed 's/\gerrit.securekey.com\/fabric-next.*/$GOPATH\/src\/github.com\/hyperledger\/fabric/g' -i $GOPATH/src/github.com/hyperledger/fabric/plugins/util/statemgr/go.mod
...
sed 's/\gerrit.securekey.com\/fabric-next.*/$GOPATH\/src\/github.com\/hyperledger\/fabric/g' -i $GOPATH/src/github.com/hyperledger/fabric/plugins/membershipsnap/pkg/membership/go.mod
