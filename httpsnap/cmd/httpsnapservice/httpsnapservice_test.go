...
func TestRequiredArg(t *testing.T) {
	...
	verifyFailure(t, HTTPServiceInvokeRequest{RequestURL: "https://127.0.0.1:8444/hello", RequestHeaders: invalidHeaders,
	...
	// Missing RequestBody
	verifyFailure(t, HTTPServiceInvokeRequest{RequestURL: "https://127.0.0.1:8444/hello", RequestHeaders: headers,
...
func TestNamedClient(t *testing.T) {
	...
	verifySuccess(t, HTTPServiceInvokeRequest{RequestURL: "https://127.0.0.1:8444/hello", RequestHeaders: headers,
...
func TestAsync(t *testing.T) {
	...
	req := HTTPServiceInvokeRequest{
		RequestURL:     "https://127.0.0.1:8444/hello",
	...
	t.Run("Invalid response", func(t *testing.T) {
		invalidReq := req
		invalidReq.RequestURL = "https://127.0.0.1:8444/test/invalidJSONResponse"
...
func TestJsonValidation(t *testing.T) {
	...
	verifyFailure(t, HTTPServiceInvokeRequest{RequestURL: "https://127.0.0.1:8444/test/abc", RequestHeaders: headers,
	...
	verifyFailure(t, HTTPServiceInvokeRequest{RequestURL: "https://127.0.0.1:8444/test/invalidJSONResponse", RequestHeaders: headers,
	...
	verifyFailure(t, HTTPServiceInvokeRequest{RequestURL: "https://127.0.0.1:8444/test/textResponse", RequestHeaders: headers,
	...
	verifyFailure(t, HTTPServiceInvokeRequest{RequestURL: "https://127.0.0.1:8444/hello", RequestHeaders: map[string]string{"Content-Type": "text/html"},
...
func TestPost(t *testing.T) {
	...
	verifyFailure(t, HTTPServiceInvokeRequest{RequestURL: "https://127.0.0.1:8444/test/statusNotOK", RequestHeaders: headers,
		RequestBody: jsonStr}, "status: 500")

	// Failed path - should get 404 back since there's no handler for xyz
	verifyFailure(t, HTTPServiceInvokeRequest{RequestURL: "https://127.0.0.1:8444/test/xyz", RequestHeaders: headers,
