...
type Client interface {
	...
	EndorseTransaction(endorseRequest *EndorseTxRequest) ([]*fabApi.TransactionProposalResponse, error)
	...
	// @returns {[]TransactionProposalResponse} responses from endorsers
	// @returns {error} error, if any
	CommitTransaction(endorseRequest *EndorseTxRequest, registerTxEvent bool, callback EndorsedCallback) ([]*fabApi.TransactionProposalResponse, error)
