...
func TestPeerFilter(t *testing.T) {
	...
	if f.Accept(membershipMocks.New("p1", org1MSP, blockHeight1)) {
	...
	if !f.Accept(membershipMocks.New("p2", org1MSP, blockHeight2)) {
	...
	if !f.Accept(membershipMocks.New("p3", org1MSP, blockHeight3)) {
