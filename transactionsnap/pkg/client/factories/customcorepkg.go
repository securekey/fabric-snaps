...
func (f *CustomCorePkg) NewCryptoSuiteProvider(config apiconfig.Config) (apicryptosuite.CryptoSuite, error) {
...
// NewFabricProvider return new fabric provider
func (f *CustomCorePkg) NewFabricProvider(context fab.ProviderContext) (apisdk.FabricProvider, error) {
