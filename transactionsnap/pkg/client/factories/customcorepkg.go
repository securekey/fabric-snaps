...
// CreateFabricProvider return new fabric provider
func (f *CustomCorePkg) CreateFabricProvider(context context.Providers) (fab.InfraProvider, error) {
	return &CustomFabricProvider{FabricProvider: fabpvdr.New(context)}, nil
}
