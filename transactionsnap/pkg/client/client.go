...
func (c *clientImpl) initialize(channelID string, serviceProviderFactory apisdk.ServiceProviderFactory) error {
	...
	sdk, err := fabsdk.New(CustomConfigProvider(clientConfig, localPeer, c.txnSnapConfig.GetTLSCertPem()),
...
func CustomConfigProvider(config apiconfig.Config, localPeer *api.PeerConfig, localPeerTlsCertPem []byte) apiconfig.ConfigProvider {
