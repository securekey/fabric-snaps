...
func (c *clientImpl) commitOnlyTransaction(response *invoke.Response, registerTxEvent bool, callback api.EndorsedCallback) (*channel.Response, bool, errors.Error) {
	...
	customExecuteHandler := handler.NewPreEndorsedHandler(response, handler.NewCommitTxHandler(registerTxEvent, c.channelID))
	...
	resp, err := c.invokeHandler(
		...
		channel.Request{ChaincodeID: "", Fcn: ""},
