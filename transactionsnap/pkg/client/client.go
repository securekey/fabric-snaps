...
func (c *clientImpl) EndorseTransaction(endorseRequest *api.EndorseTxRequest) ([]*fabApi.TransactionProposalResponse, error) {
...
func (c *clientImpl) CommitTransaction(endorseRequest *api.EndorseTxRequest, registerTxEvent bool, callback api.EndorsedCallback) ([]*fabApi.TransactionProposalResponse, error) {
