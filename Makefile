...
FABRIC_NEXT_VERSION = 1c9f684ee08703a53e9cdc84d6a0b88d54e2dda5
# When this tag is updated, we should also change bddtests/fixtures/.env
# to support running tests without 'make'
export FABRIC_NEXT_IMAGE_TAG = 1.4.1-0.0.2-snapshot-1c9f684
...
FABRIC_BASE_IMAGE_VERSION=$(ARCH)-0.4.15
