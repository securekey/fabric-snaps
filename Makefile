...
FABRIC_NEXT_VERSION ?= 8af5d6a3a3cb93632821c1f7a3a83c9716f43f20
...
ifndef FABRIC_NEXT_IMAGE_TAG
  export FABRIC_NEXT_IMAGE_TAG = 0.0.1-snapshot-8af5d6a
endif
...
snaps: version clean
	...
	@docker run -i --rm \
		...
		securekey/fabric-build-snaps:amd64-0.4.14 \
