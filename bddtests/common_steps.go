...
//		chaincodeID, args, []sdkApi.ProposalProcessor{primaryPeer}, transientData, orgID)
...
//	args []string, targets []sdkApi.ProposalProcessor, transientData map[string][]byte, orgID string) ([]*sdkApi.TransactionProposalResponse, sdkApi.TransactionID, error) {
...
//	}
//	var transactionProposalResponses []*sdkApi.TransactionProposalResponse
...
//	}
//	sdkPeer, err := d.BDDContext.sdk.FabricProvider().CreatePeerFromConfig(&apiconfig.NetworkPeer{PeerConfig: *peerConfig, MspID: mspID})
//	if err != nil {
//		return errors.WithMessage(err, "NewPeer failed")
//	}
...
func (d *CommonSteps) querySystemCC(ccID, args, orgID, channelID string) error {
	...
	queryResult, err := d.QueryCCWithArgs(true, ccID, channelID, strings.Split(args, ","),
