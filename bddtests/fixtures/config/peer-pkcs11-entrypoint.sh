#!/usr/bin/env bash
################################################################################
# https://github.com/gbolo/dockerfiles/blob/master/hyperledger-fabric/softhsm/dockerfiles/install/entrypoint.sh
# https://github.com/gbolo/dockerfiles/blob/master/hyperledger-fabric/softhsm/dockerfiles/install/entrypoint-functions.sh
#
...
START_DAEMON() {
  BROADCAST_MSG "STARTING PEER DAEMON..."
  peer node start
}
