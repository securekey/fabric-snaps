...
Feature:  Feature Invoke Transaction Snap
	...
	Scenario: Invoke Transaction Snap commitTransaction,endorseTransaction function
        ...
        And response from "txnsnapinvoker" with args "txnsnap,commitOnlyTransaction,mychannel,example_cc,invoke,move,a,b,1" on org "peerorg1" peer on the "mychannel" channel
