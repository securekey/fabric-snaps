...
const (
	validMsgMultiplePeersAndApps = `{"MspID":"Org1MSP","Peers":[{"PeerID":"peer.one.one.example.com","App":[{"AppName":"appNameR","Versions":[{"Version":"$v","Config":"configstringgoeshere"}]},{"AppName":"appNameB","Versions":[{"Version":"$v","Config":"config for appNametwo"}]},{"AppName":"appNameC","Versions":[{"Version":"$v","Config":"mnopq"}]}]},{"PeerID":"peer.two.two.example.com","App":[{"AppName":"appNameHH","Versions":[{"Version":"1","Config":"config for appNameTwoOnPeerOne goes here"}]},{"AppName":"appNameMM","Versions":[{"Version":"$v","Config":"config for appNameOneTwo goes here"}]},{"AppName":"appNameQQ","Versions":[{"Version":"$v","Config":"BLTwo"}]}]}]}`
	...
	configMsg := &configmanagerApi.ConfigMessage{MspID: "Org1MSP",
		Peers: []configmanagerApi.PeerConfig{configmanagerApi.PeerConfig{
			PeerID: "peer1", App: []configmanagerApi.AppConfig{
				configmanagerApi.AppConfig{AppName: "configurationsnap", Versions: []configmanagerApi.VersionConfig{
					configmanagerApi.VersionConfig{Version: api.VERSION, Config: string(configData)}}}}}}}
