...
import (
	...
	commonledger "github.com/securekey/fabric-snaps/internal/github.com/hyperledger/fabric/common/ledger"
	"github.com/securekey/fabric-snaps/internal/github.com/hyperledger/fabric/core/comm"
	queryresult "github.com/securekey/fabric-snaps/internal/github.com/hyperledger/fabric/protos/ledger/queryresult"
	pbinternal "github.com/securekey/fabric-snaps/internal/github.com/hyperledger/fabric/protos/peer"
	"github.com/securekey/fabric-snaps/internal/github.com/hyperledger/fabric/protos/utils"
	flogging "github.com/securekey/fabric-snaps/internal/github.com/hyperledger/fabric/sdkpatch/logbridge"
	logging "github.com/securekey/fabric-snaps/internal/github.com/hyperledger/fabric/sdkpatch/logbridge"
...
func userChaincodeStreamGetter(name string) (PeerChaincodeStream, error) {
	...
	chaincodeSupportClient := pbinternal.NewChaincodeSupportClient(clientConn)
...
// API for chaincodes.
func StartInProc(env []string, args []string, cc Chaincode, recv <-chan *pbinternal.ChaincodeMessage, send chan<- *pbinternal.ChaincodeMessage) error {
...
func chatWithPeer(chaincodename string, stream PeerChaincodeStream, cc Chaincode) error {
	...
	chaincodeLogger.Debugf("Registering.. sending %s", pbinternal.ChaincodeMessage_REGISTER)
	if err = handler.serialSend(&pbinternal.ChaincodeMessage{Type: pbinternal.ChaincodeMessage_REGISTER, Payload: payload}); err != nil {
	...
	go func() {
		defer close(waitc)
		msgAvail := make(chan *pbinternal.ChaincodeMessage)
		var nsInfo *nextStateInfo
		var in *pbinternal.ChaincodeMessage
		recv := true
		for {
			in = nil
			err = nil
			...
			if recv {
				recv = false
				go func() {
					var in2 *pbinternal.ChaincodeMessage
					in2, err = stream.Recv()
					msgAvail <- in2
				}()
			}
			...
			if in.Type == pbinternal.ChaincodeMessage_KEEPALIVE {
...
type CommonIterator struct {
	handler    *Handler
	uuid       string
	response   *pbinternal.QueryResponse
	currentLoc int
}
...
func (iter *CommonIterator) getResultFromBytes(queryResultBytes *pbinternal.QueryResultBytes,
