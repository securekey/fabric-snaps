...
type ChaincodeMessage struct {
	...
	Proposal  *pb.SignedProposal          `protobuf:"bytes,5,opt,name=proposal" json:"proposal,omitempty"`
	// event emmited by chaincode. Used only with Init or Invoke.
	// This event is then stored (currently)
	// with Block.NonHashData.TransactionResult
	ChaincodeEvent *pb.ChaincodeEvent `protobuf:"bytes,6,opt,name=chaincode_event,json=chaincodeEvent" json:"chaincode_event,omitempty"`
}
...
func (m *ChaincodeMessage) GetProposal() *pb.SignedProposal {
	if m != nil {
		return m.Proposal
	}
	return nil
...
func (m *ChaincodeMessage) GetChaincodeEvent() *pb.ChaincodeEvent {
	if m != nil {
